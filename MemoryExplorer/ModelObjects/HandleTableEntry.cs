...
namespace MemoryExplorer.ModelObjects
{
    public class HandleTableEntry : StructureBase
    {
        ...
        private void Parse()
        {
            _unlocked = (Members.Unlocked & 0x01) == 1;
            _referenceCount = (Members.RefCnt & 0x1fffe) >> 1;
            _objectPointer = (Members.ObjectPointerBits & 0xfffffffffff00000) >> 16;
            _typeInfo = Members.TypeInfo;
            _grantedAccess = Members.GrantedAccessBits & 0x1ffffff;
