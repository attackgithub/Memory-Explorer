...
namespace MemoryExplorer.HexView
{
    [ToolboxBitmap(typeof(HexViewerControl), "HexBox.bmp")]
    public class HexViewerControl : Control
    {
        ...
        public int AddHighlight(long start, long end, Color fore, Color back)
        {
            ...
            hl.startByte = start;
            hl.endByte = end;
            hl.foregroundColour = fore;
            hl.backgroundColour = back;
        ...
        {
            HexViewerControl _hexBox;

            public EmptyKeyInterpreter(HexViewerControl hexBox)
            {
                _hexBox = hexBox;
            }
        ...
        class KeyInterpreter : IKeyInterpreter
        {
            ...
            /// </summary>
            protected HexViewerControl _hexBox;
            ...
            #region Ctors
            public KeyInterpreter(HexViewerControl hexBox)
            {
                _hexBox = hexBox;
            }
            #endregion
        ...
        {
            #region Ctors
            public StringKeyInterpreter(HexViewerControl hexBox)
                : base(hexBox)
            {
        ...
        void PaintLineInfo(Graphics g, long startByte, long endByte)
        {
            ...
            {
                long firstLineByte = (startByte + (_iHexMaxHBytes) * i) + (long)_lineInfoOffset;
        ...
        void PaintHexAndStringView(Graphics g, long startByte, long endByte)
        {
            ...
            Brush selBrush = new SolidBrush(_selectionForeColor);
            Brush selBrushBack = new SolidBrush(_selectionBackColor);
            Brush hiBrush = new SolidBrush(Color.Red);
            ...
            for (long i = startByte; i < intern_endByte + 1; i++)
            {
                ...
                foreach (long l in lookup)
                {
                    if (l == i)
                    {
                        ...
                        foreach (Highlight hl in highlightList)
                        {
                            ...
                            {
                                hiBrush = new SolidBrush(hl.foregroundColour);
                                hiBrushBack = new SolidBrush(hl.backgroundColour);
                                break;
                            }
                        }
                        break;
                ...
                if (trigger && !isSelectedByte)
                    PaintHexStringSelected(g, b, hiBrush, hiBrushBack, gridPoint);
        ...
        void UpdateRectanglePositioning()
        {
            ...
            int requiredWidth = 10; // mark - was 0
            ...
            if (_lineInfoVisible)
            {
                _recLineInfo = new Rectangle(_recContent.X + marginLeft, _recContent.Y, (int)(_charSize.Width * 18), _recContent.Height);
    ...
    public class Highlight
    {
        ...
        public Color foregroundColour = Color.Empty;
        public Color backgroundColour = Color.Empty;
